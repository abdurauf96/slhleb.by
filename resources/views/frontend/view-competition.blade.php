        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-md-8">
                    ...
                    <div>{{ \Carbon\Carbon::parse($competition->end_time) > \Carbon\Carbon::today()? "" : "(Конкурс завершен)" }}</div>
                            ...
                            <div class="item">
                                ...
                                <div class="item-name">
                                    ...
                                    <div class="votes" style="display: flex">
 									...
 									<a href="/who-is-voted/{{ $item->id }}"> смотреть статистику </a>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="item">
                                ...
                                <div class="item-name">
                                    ...
                                    <h2>@lang('messages.uchas') â„– {{ $loop->iteration }}</h2>

                                    <h3>{{ $part['name_'.\App::getLocale()] }}</h3>

                                    <p style="border-bottom: 1px solid #fff;">{{ $part['desc_'.\App::getLocale()] }}</p>

                                    <div class="votes" style="display: flex;">

                                        <p>Всего голосов:   </p> 

                                        <p class="num_votes" style="margin-left: 5px;">{{ $part->vote }}</p>
            ...
            <div class="modal-body">
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p><a href="/images/stocks/{{ $competition->rules }}">Ð¡ÐºÐ°Ñ‡Ð°Ñ‚ÑŒ</a></p>
            ...
            <div class="modal-body">
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p> <a href="/images/stocks/{{ $competition->state }}">Ð¡ÐºÐ°Ñ‡Ð°Ñ‚ÑŒ</a> </p>
