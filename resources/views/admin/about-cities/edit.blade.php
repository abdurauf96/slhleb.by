...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Edit AboutCity #{{ $aboutcity->id }}</div>
                    <div class="card-body">
                        ...
                        {!! Form::model($aboutcity, [
                            'method' => 'PATCH',
                            'url' => ['/admin/about-cities', $aboutcity->id],
                            'class' => 'form-horizontal',
                            'files' => true
                        ]) !!}

                        @include ('admin.about-cities.form', ['formMode' => 'edit'])
