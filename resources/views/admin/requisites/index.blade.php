            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        {!! Form::open(['method' => 'GET', 'url' => '/admin/requisites', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $requisites->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
