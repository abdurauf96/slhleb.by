...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Create New Requisite</div>
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => '/admin/requisites', 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('admin.requisites.form', ['formMode' => 'create'])
