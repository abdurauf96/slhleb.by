            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/admin/videos', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Заголовок Ru</th><th>Линк</th><th>Действия</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($videos as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->title_ru }}</td><td>{{ $item->link }}</td>
                                        <td>
