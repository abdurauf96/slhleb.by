                       ...
                       <div class="form-body">
                                ...
                                <div class="form-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $action=='update' ? $attr['weight_ru'] : '' }}" class="form-control" id="" placeholder="Вес" name="weights_ru[]">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $action=='update' ? $attr['weight_by'] : '' }}" class="form-control" id="" placeholder="Вес" name="weights_by[]">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $action=='update' ? $attr['weight_en'] : '' }}" class="form-control" id="" placeholder="Вес" name="weights_en[]">
                                ...
                                <div class="form-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" id="" placeholder="Вес" name="weights_ru[]">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" id="" placeholder="Вес" name="weights_by[]">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" id="" placeholder="Вес" name="weights_en[]">
